    ...
    >
      ...
      >
        <div>
          ...
          <p style={{ color: "rgba(255,255,255,0.48)", fontSize: "0.82rem", lineHeight: 1.75 }}>
            Přírodní mateřská škola v Machově. Vzdělávání hrou v přírodě pro děti od 3 do 7 let.
          </p>
        </div>

        <div>
          <div style={{ color: T.pale, fontWeight: 800, fontSize: "0.73rem", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "0.9rem" }}>
            Navigace
          </div>
          {NAV_ITEMS.map((item) => (
            <Link key={item.href} href={item.href} style={{ display: "block", color: "rgba(255,255,255,0.52)", fontSize: "0.83rem", marginBottom: "0.45rem" }}>
              {item.label}
            </Link>
          ))}
        </div>
        ...
        <div>
          ...
          <p style={{ color: "rgba(255,255,255,0.52)", fontSize: "0.82rem", lineHeight: 1.75 }}>
            Machov 58, 549 63
            <br />
            +420 737 787 061
            <br />
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.07)", marginTop: "2rem", paddingTop: "1.3rem", textAlign: "center", color: "rgba(255,255,255,0.22)", fontSize: "0.75rem" }}>
